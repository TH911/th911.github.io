...
![](https://cfyy.us.kg/img/2024/10/019.png)
...
>
> 以下的朴素 Tarjan 实现复杂度为 $\mathcal O(m\alpha(m+n,n)+n)$。如果需要追求严格线性，可以参考 [Gabow 和 Tarjan 于 1983 年的论文](https://cfyy.us.kg/file/2024/10/Tarjan.pdf)。其中给出了一种复杂度为 $\mathcal O(n+m)$ 的做法。——[OI Wiki](https://oi-wiki.org/graph/lca/#%E6%80%A7%E8%B4%A8_3)
