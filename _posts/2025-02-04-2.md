...
$$
\begin{aligned}
\operatorname*{kthmax}_{i\in S}x_i&=\sum_{T\subseteq S}(-1)^{\vert T\vert-k}\dbinom{\vert T\vert-1}{k-1}\operatorname*{kthmin}_{i\in T}x_i\\
\operatorname*{kthmin}_{i\in S}x_i&=\sum_{T\subseteq S}(-1)^{\vert T\vert-k}\dbinom{\vert T\vert-1}{k-1}\operatorname*{kthmax}_{i\in T}x_i\\
E\left(\operatorname*{kthmax}_{i\in S}x_i\right)&=\sum_{T\subseteq S}(-1)^{\vert T\vert-k}\dbinom{\vert T\vert-1}{k-1}E\left(\operatorname*{kthmin}_{i\in T}x_i\right)\\
E\left(\operatorname*{kthmin}_{i\in S}x_i\right)&=\sum_{T\subseteq S}(-1)^{\vert T\vert-k}\dbinom{\vert T\vert-1}{k-1}E\left(\operatorname*{kthmax}_{i\in T}x_i\right)\\
\end{aligned}
$$
